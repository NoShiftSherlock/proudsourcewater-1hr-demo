/* Proud Source × Vesper Commerce — 1-hour delivery mockup interactions */

// ---------- Product catalog (homepage grid) ----------
const PRODUCTS = [
  {
    "line": "",
    "name": "Alkaline Spring Water Cans",
    "img": "assets/p0.jpg",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "",
    "name": "Sparkling Spring Water Cans",
    "img": "assets/p1.jpg",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "",
    "name": "Made in America Alkaline Spring Water Cans (16",
    "img": "assets/p2.jpg",
    "price": "$36.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "",
    "name": "Made in America Sparkling Spring Water Cans (1",
    "img": "assets/p3.jpg",
    "price": "$36.99",
    "status": "",
    "rating": "",
...
// ---------- On-demand catalog (Proud Source Now page) ----------
const NOW_PRODUCTS = [
  {
    "line": "",
    "format": "Single",
...
// Proud Source Now address check -> reveal grid
function nowCheck() {
...
function placeOrder() {
  ...
  toast(oneHr ? "Order placed ⚡ Routing to nearest store — arriving in ~52 min"
              : "Order placed ✓ Thanks — your Proud Source order is confirmed.");
}
document.addEventListener("DOMContentLoaded", updateCheckoutTotals);

// ---------- Slide-out cart drawer + rewards meter ----------
const CART = {"name": "Alkaline Spring Water Cans", "line": "", "img": "assets/p0.jpg", "unit": 33.99, "qty": 2, "sub": false};
const TIERS = [
...
function injectMobileMenu() {
  ...
  const active = location.pathname.endsWith("proudsourcewater-now.html") ? "brand-now" : "";
  const wrap = document.createElement("div");
  wrap.innerHTML = `
    <div class="menu-overlay" id="menuOverlay" onclick="closeMenu()"></div>
    <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
      <div class="mm-head">
        <span class="wordmark">Proud Source</span>
      ...
      <div class="mm-links">
        ...
        <a href="proudsourcewater-now.html" class="${active === "brand-now" ? "active" : ""}">Proud Source Now</a>
      </div>
      <div class="mm-cta"><a href="proudsourcewater-now.html" class="btn btn-white btn-block">⚡ Check your address</a></div>
      <div class="mm-sub">
